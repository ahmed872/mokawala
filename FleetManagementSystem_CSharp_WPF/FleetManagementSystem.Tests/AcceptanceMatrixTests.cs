...
public class AcceptanceMatrixTests
{
    ...
    private static IReadOnlyList<AcceptanceCheck> BuildDataChecks(AcceptanceHarness harness, SeedData seed) =>
        new List<AcceptanceCheck>
        {
            ...
            new("oil report next change odometer", async () => Assert.Contains(await Rows(harness, "oilchanges"), r => Number(r, "التغيير القادم") == 9800m)),
            ...
            new("insurance report active status", async () => Assert.Contains(await Rows(harness, "insurance"), r => Text(r, "الحالة") == "Active")),
